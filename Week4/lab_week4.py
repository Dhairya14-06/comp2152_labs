...
print("You see Monster in the distance! So, quickly use your first item!")
first_item = belt.pop(0)
if first_item in good_loot_options:
    health_points = min(6, (health_points + 2))
    print(f"You use the{first_item}, and your health changed to {health_points}")
elif first_item in bad_loot_options:
    health_points = max(6, (health_points -2))
    print(f"You use the{first_item}, and your health changed to {health_points}")
else:
    print(f"You use the{first_item}, but it was not helpful!") 
...
input("Roll for the Monster's Maguc Power(Press Enter)")
power_roll = random.choice(["Fire Magic", "Freezing Time", "Super Hearing"])

#lab04 - Q3
# Increase the Monster's Combat Strength by it's Power
